    ...
    try {
      ...
      setError(
        err instanceof Error
          ? err.message
          : "Failed to save profile, AuthContext",
      );
    } finally {
        ...
        <div className="max-w-xl mx-auto">
          {!isGenerating ? (
              ...
              <form onSubmit={handleQuestionaire} className="space-y-5">
                ...
                <div className="flex gap-3 pt-2">
                  <Button type="submit" className="flex-1 gap-2">
                    Generate My Plan <ArrowRightIcon className="w-4 h-4" />
                  </Button>
                </div>
              </form>
            </Card>
            ...
            <Card variant="bordered" className="text-center py-16">
              <Loader2 className="w-12 h-12 text-accent mx-auto mb-10 animate-spin" />
              <h1 className="text-2xl font-bold mb-5">Creating Your Plan</h1>
              <p className="text-muted text-sm">
                Our AI is builidng your Personalized Training Program....
              </p>
            </Card>
          )}
        </div>
